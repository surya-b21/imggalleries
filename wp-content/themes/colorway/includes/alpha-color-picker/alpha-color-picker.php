 ...
 */
class Colorway_Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/includes/alpha-color-picker/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/includes/alpha-color-picker/alpha-color-picker.css',
