...
Colorway_About_Page::init( apply_filters( 'colorway_about_page_array', $config ) );
...
Colorway_Customizer_Notify::init( apply_filters( 'colorway_customizer_notify_array', $config_customizer ) );
