...
if ( ! class_exists( 'Colorway_About_Page' ) ) {
	 ...
	 */
	class Colorway_About_Page {
		/**
		 * Define the version of the class.
		 *
		 * @var string $version The Colorway_About_Page class version.
		 */
		...
		/**
		 * The single instance of Colorway_About_Page
		 *
		 * @var Colorway_About_Page $instance The  Colorway_About_Page instance.
		 */
		private static $instance;

		/**
		 * The Main Colorway_About_Page instance.
		 *
		 * We make sure that only one instance of Colorway_About_Page exists in the memory at one time.
		 *
		 * @param array $config The configuration array.
		 */
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Colorway_About_Page ) ) {
				self::$instance = new Colorway_About_Page;
...
//			$this->tabs          = isset( $this->config['tabs'] ) ? $this->config['tabs'] : array();
		 ...
		 */
		public function colorway_about_page_render() {
