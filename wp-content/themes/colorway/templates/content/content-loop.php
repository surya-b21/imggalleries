        ...
        <div class="row"> 
            ...
            <div class="<?php echo esc_attr($class); ?>">
                <div class="blog-content">
                    <ul class="post_meta">
                        <?php if (colorway_get_option('inkthemes_author','on')=='on') { ?>
                            <li class="posted_by"><span><?php esc_html_e('By', 'colorway'); ?> </span><?php the_author_posts_link(); ?></li>
                        <?php } ?>
                        <?php if (colorway_get_option('inkthemes_categories','on')=='on') { ?>
                            <li class="posted_in"><?php the_category(', '); ?></li>
                        <?php } ?>
                        <?php if (colorway_get_option('inkthemes_date','on')=='on') { ?>
                            <li class="post_date"><?php esc_html_e('On ', 'colorway') . the_time('F j, Y'); ?></li>
                        <?php } ?>
                        <?php if (colorway_get_option('inkthemes_comments','on')=='on') { ?>
